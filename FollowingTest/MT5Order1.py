...
def login_mt5():
    ...
    path="D:/Program Files/MetaTrader5_1/terminal64.exe"
...
def create_order(symbol, action, volume, price=None, sl=None, tp=None):
    ...
    GlobalVariableSet("FollowSignal_Symbol", symbol);
    GlobalVariableSet("FollowSignal_Type", action); 
    GlobalVariableSet("FollowSignal_Volume", volume); 
    GlobalVariableSet("FollowSignal_Price", price);
    GlobalVariableSet("FollowSignal_Time", TimeCurrent());
    return result.order
